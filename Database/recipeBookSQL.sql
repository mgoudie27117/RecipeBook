CREATE TABLE RECIPEBOOK_SECURITY_QUESTIONS 
(
  SECURITY_QUESTION_ID NUMBER NOT NULL 
, SECURITY_QUESTION VARCHAR2(150 CHAR) NOT NULL 
, CONSTRAINT RECIPEBOOK_SECURITY_QUESTIONS_PK PRIMARY KEY 
  (
...
CREATE SEQUENCE RECIPEBOOK_SECURITY_QUESTIONS_SEQ;

CREATE TRIGGER RECIPEBOOK_SECURITY_QUESTIONS_TRG 
BEFORE INSERT ON RECIPEBOOK_SECURITY_QUESTIONS 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
  BEGIN
    IF INSERTING AND :NEW.SECURITY_QUESTION_ID IS NULL THEN
      SELECT RECIPEBOOK_SECURITY_QUESTIONS_SEQ.NEXTVAL INTO :NEW.SECURITY_QUESTION_ID FROM SYS.DUAL;
    END IF;
  END COLUMN_SEQUENCES;
END;

INSERT ALL
    INTO recipebook_security_questions (security_question) VALUES ('What city were you born in?')
    INTO recipebook_security_questions (security_question) VALUES ('What is the last name of your favorite teacher?')
    INTO recipebook_security_questions (security_question) VALUES ('What is your favorite color?')
SELECT 1 FROM dual
;
COMMIT;
...
ALTER TABLE RECIPEBOOK_USER 
ADD (SECURITY_QUESTION_ID NUMBER NOT NULL);

ALTER TABLE RECIPEBOOK_USER 
ADD (SECURITY_ANSWER VARCHAR2(255 CHAR) NOT NULL);

ALTER TABLE RECIPEBOOK_USER
ADD CONSTRAINT RECIPEBOOK_USER_FK1 FOREIGN KEY
(
  SECURITY_QUESTION_ID 
)
REFERENCES RECIPEBOOK_SECURITY_QUESTIONS
(
  SECURITY_QUESTION_ID 
)
ENABLE;

CREATE OR REPLACE TRIGGER RECIPEBOOK_USER_TRG 
BEFORE INSERT ON RECIPEBOOK_USER 
FOR EACH ROW 
BEGIN
  <<COLUMN_SEQUENCES>>
...
CREATE TABLE RECIPEBOOK_FAVORITE_RECIPES 
(
  USER_ID NUMBER NOT NULL 
, RECIPE_ID NUMBER NOT NULL 
, CONSTRAINT RECIPEBOOK_FAVORITE_RECIPES_PK PRIMARY KEY 
  (
    RECIPE_ID 
  , USER_ID 
  )
...
ALTER TABLE RECIPEBOOK_FAVORITE_RECIPES
ADD CONSTRAINT RECIPEBOOK_FAVORITE_RECIPES_FK1 FOREIGN KEY
(
  RECIPE_ID 
)
REFERENCES RECIPEBOOK_RECIPES
...
ALTER TABLE RECIPEBOOK_FAVORITE_RECIPES
ADD CONSTRAINT RECIPEBOOK_FAVORITE_RECIPES_FK2 FOREIGN KEY
(
  USER_ID 
)
REFERENCES RECIPEBOOK_USER
...
CREATE TABLE RECIPEBOOK_RECIPE_REVIEWS 
(
  USER_ID NUMBER NOT NULL 
, RECIPE_ID NUMBER NOT NULL 
, RATING NUMBER NOT NULL 
, COMMENTS BLOB NOT NULL 
, CONSTRAINT RECIPEBOOK_RECIPE_REVIEWS_PK PRIMARY KEY 
  (
    USER_ID 
  , RECIPE_ID 
  )
...
ALTER TABLE RECIPEBOOK_RECIPE_REVIEWS
ADD CONSTRAINT RECIPEBOOK_RECIPE_REVIEWS_FK1 FOREIGN KEY
(
  USER_ID 
)
REFERENCES RECIPEBOOK_USER
...
ALTER TABLE RECIPEBOOK_RECIPE_REVIEWS
ADD CONSTRAINT RECIPEBOOK_RECIPE_REVIEWS_FK2 FOREIGN KEY
(
  RECIPE_ID 
)
REFERENCES RECIPEBOOK_RECIPES
