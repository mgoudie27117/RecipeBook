...
public class RecipeTest {
    ...
    public void recipeObjectGettersTest() {
        ...
        Recipe recipeTest3 = new SharedRecipe("TEST_NAME", "TEST_DESCRIPTION", 1, "TEST_INSTRUCTIONS", compositeTest);
        ...
        Recipe recipeTest5 = new SharedRecipe("TEST_NAME", "TEST_DESCRIPTION", 1, "TEST_INSTRUCTIONS", arrayTest);
